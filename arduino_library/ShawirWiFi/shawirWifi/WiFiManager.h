...
// Default: Bahasa Indonesia (LANG_ID)
// Override: tambahkan #define LANG_EN / LANG_DE / LANG_ES / LANG_FR di sketch
#if defined(LANG_DE)
  ...
  #include "wm_strings_id.h"
#else
  #include "wm_strings_id.h" // Default: Bahasa Indonesia - Modern Dark UI
#endif
