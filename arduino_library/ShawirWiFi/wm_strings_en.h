 ...
 * wm_strings_en.h
 * English strings for
 * shawirWifi, a library for the ESP8266/Arduino platform
...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h1>{t}</h1><h3>shawirWifi v{v}</h3>";
...
const char S_resetting[]          PROGMEM = "shawirWifi: Module will reset in a few seconds.";
